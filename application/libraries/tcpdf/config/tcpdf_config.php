 ...
 */
define ('PDF_HEADER_LOGO', 'logo2.jpeg');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Surat');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "PEMERINTAH PROVINSI JAWA TENGAH","DINAS PENDIDIKAN DAN KEBUDAYAAN");
