                ...
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        <div class="page-header">
                            <h4><p class="text-info">Isi Data berikut untuk mengubah Surat Keluar.</p></h4>
                        </div><!-- /.page-header -->

                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                <form enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php echo base_url('sk/edit'); ?>" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="jenis_surat_keluar" class="col-sm-9"><input type="text" name="jenis_surat_keluar" class="form-control" value="<?php echo $sk['jenis_surat_keluar']; ?>" placeholder="Jenis Surat" required ></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="perihal" class="col-sm-3 control-label no-padding-right" for="form-field-1">Perihal :</label> 
                                        <div id="perihal" class="col-sm-9"><input type="text" name="perihal" class="form-control" value="<?php echo $sk['perihal']; ?>" placeholder="Perihal" required ></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="dikirim" class="col-sm-3 control-label no-padding-right" for="form-field-1">Dikirim :</label> 
                                        <div id="dikirim" class="col-sm-9"><input type="text" name="dikirim" class="form-control" value="<?php echo $sk['dikirim']; ?>" placeholder="Dikirim" required ></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="tgl_penetapan" class="col-sm-3 control-label no-padding-right" for="form-field-1">Tanggal Penetapan :</label> 
                                        <div id="tgl_penetapan" class="col-sm-9"><input type="date" name="tgl_penetapan" value="<?php echo $sk['tgl_penetapan_skeluar']; ?>" class="form-control" required ></div>
                                    </div>
                                    <div class="form-group">
                                        <label for="isi" class="col-sm-3 control-label no-padding-right">Isi :</label> 
                                        <div class="col-sm-9">
                                        <textarea id="texteditor" class="tinymce" name="isi"><?php echo $sk['isi']; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group"> 
