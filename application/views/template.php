...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>SIMASKU :: SMA NEGERI 1 KESESI</title>
		...
		<!-- tambahan -->
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css') ?>">
   		<link rel="stylesheet" type="text/css" href="<?php echo base_url('https://cdn.datatables.net/1.10.16/css/dataTables/bootstrap4.min.css') ?>">
   		<link rel="stylesheet" media="screen" charset="utf-8" href="<?php echo base_url('assets/css/summernote.css') ?>">
   		<script src="https://cdn.ckeditor.com/ckeditor5/11.0.1/decoupled-document/ckeditor.js"></script>
   		<script src="<?php echo base_url();?>assets/js/ckeditor.js"></script>

   		<script href="<?php echo base_url('https://ajax.googleapis.com/ajax/libs/jquery/2.2.0/jquery.min.js') ?>"></script>
					...
					<ul class="nav ace-nav">
						<li class="light-blue dropdown-modal">
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li>
									<a href="<?php echo base_url('pengaturanpass'); ?>">
				...
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder">SIMASKU</span>
							Application &copy; 2018<br>
							<span class="green bolder">Develop By</span>
							TA-1813 
							<span class="red bolder">Akademi Komunitas Negeri Kajen</span>
						</span>
